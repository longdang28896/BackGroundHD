...
export default function Picture({ navigation }) {
  ...
  fetch('://www.flihttpsckr.com/services/rest/?method=flickr.favorites.getList&api_key=d563ba7735076d92449b15bb29d210eb&user_id=187015156%40N07&extras=views%2C+media%2C+path_alias%2C+url_sq%2C+url_t%2C+url_s%2C+url_q%2C+url_m%2C+url_n%2C+url_z%2C+url_c%2C+url_l%2C+url_o&format=json&nojsoncallback=1')
